...
TOOLS: list[ToolDef] = [
    ...
    ToolDef("fetchMatchedMarkets", "fetchMatchedMarkets", "Fetch all matched market pairs from the catalog.",
            [_a("params", flatten=True)], read_only=True, category="router"),
    ToolDef("fetchMatchedMarketClusters", "fetchMatchedMarketClusters",
            "Fetch cross-venue market clusters with relation and confidence evidence.",
            [_a("params", flatten=True)], read_only=True, category="router"),
    ToolDef("fetchMatchedEventClusters", "fetchMatchedEventClusters",
            "Fetch cross-venue event clusters with relation and confidence evidence.",
            [_a("params", flatten=True)], read_only=True, category="router"),
